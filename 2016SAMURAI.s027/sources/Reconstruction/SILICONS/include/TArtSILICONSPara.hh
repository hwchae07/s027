...
public:
  ...
  TArtSILICONSPara(UShort_t id, TString n, UShort_t f, 
		   UShort_t l, UShort_t s, DetDirection d, 
		   Double_t p[], 
		   Double_t tc, Double_t to, Double_t qc, Double_t qp){
    SetParameters(id, n,  f, l,  s, d,  p, tc,  to,  qc,  qp);
  }
  ~TArtSILICONSPara() { }
  ...
  void SetMap(Int_t tgeo, Int_t tch, 
    ...
    map_adc.SetMap(fpl,SIGSI,adc_geo,adc_ch); 
    map_tdc.SetMap(fpl,SIGSI,tgeo,tch); 
  }
