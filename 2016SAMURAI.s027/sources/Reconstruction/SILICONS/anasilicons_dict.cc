...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtSILICONSParameters*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtSILICONS*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtSILICONSPara*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtCalibSILICONS*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TArtSILICONSPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TArtSILICONSPara*>", -2, "vector", 214,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<TArtRIDFMap,TArtSILICONSPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<TArtRIDFMap,TArtSILICONSPara*>", -2, "map", 96,
...
"/usr/local/include",
"/home/hwchae07/Programs/anaroot/2016SAMURAI.s027/sources/Reconstruction/SILICONS/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("anasilicons_dict",
        ...
        TriggerDictionaryInitialization_anasilicons_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
