...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TArtCATANAParameters*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TArtCATANAParameters", ::TArtCATANAParameters::Class_Version(), "TArtCATANAParameters.hh", 12,
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtCalibCATANA*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtCATANACsI*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtCATANACsIPara*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtCATANAParameters*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TArtCATANACsIPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TArtCATANACsIPara*>", -2, "vector", 214,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<TArtRIDFMap,TArtCATANACsIPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<TArtRIDFMap,TArtCATANACsIPara*>", -2, "map", 96,
...
"/usr/local/include",
"/home/hwchae07/Programs/anaroot/2016SAMURAI.s027/sources/Reconstruction/CATANA/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("anacatana_dict",
        ...
        TriggerDictionaryInitialization_anacatana_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
