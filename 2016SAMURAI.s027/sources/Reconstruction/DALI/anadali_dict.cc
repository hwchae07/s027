...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TArtCalibDALI*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TArtCalibDALI", ::TArtCalibDALI::Class_Version(), "TArtCalibDALI.hh", 17,
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtDALINaIPara*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtDALIParameters*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtCalibDALI*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtDALINaI*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TArtDALINaIPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TArtDALINaIPara*>", -2, "vector", 214,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<TArtRIDFMap,TArtDALINaIPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<TArtRIDFMap,TArtDALINaIPara*>", -2, "map", 96,
...
"/usr/local/include",
"/home/hwchae07/Programs/anaroot/2016SAMURAI.s027/sources/Reconstruction/DALI/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("anadali_dict",
        ...
        TriggerDictionaryInitialization_anadali_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
