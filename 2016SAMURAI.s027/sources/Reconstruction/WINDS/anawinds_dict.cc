...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtWINDSPla*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtWINDSPlaPara*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtCalibWINDSPla*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtWINDSParameters*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TArtWINDSPlaPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TArtWINDSPlaPara*>", -2, "vector", 214,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<TArtRIDFMap,TArtWINDSPlaPara*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<TArtRIDFMap,TArtWINDSPlaPara*>", -2, "map", 96,
...
"/usr/local/include",
"/home/hwchae07/Programs/anaroot/2016SAMURAI.s027/sources/Reconstruction/WINDS/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("anawinds_dict",
        ...
        TriggerDictionaryInitialization_anawinds_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
