...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncSub*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtValIndex*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtValIndexVal*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtValIndexValArray*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtValMap*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtAnaGate*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtAnaFile*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncHist*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncBranch*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlRawDataExample*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtAnaLoopManager*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TArtAnaLoopStatic*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncFactory*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncStop*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncFillTree*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncGate*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TAlEncPrint*)0x0)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TArtValIndexVal>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TArtValIndexVal>", -2, "vector", 214,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<TArtValIndex>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<TArtValIndex>", -2, "vector", 214,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,vector<TArtValIndex> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<string,vector<TArtValIndex> >", -2, "map", 96,
...
namespace ROOT {
   static TClass *maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR_Dictionary();
   static void maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR_TClassManip(TClass*);
   static void *new_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p = 0);
   static void *newArray_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(Long_t size, void *p);
   static void delete_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p);
   static void deleteArray_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p);
   static void destruct_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,bool(TArtAnaFile::*)(std::string,int,string)>*)
   {
      map<string,bool(TArtAnaFile::*)(std::string,int,string)> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(map<string,bool(TArtAnaFile::*)(std::string,int,string)>));
      static ::ROOT::TGenericClassInfo 
         instance("map<string,bool(TArtAnaFile::*)(std::string,int,string)>", -2, "map", 96,
                  typeid(map<string,bool(TArtAnaFile::*)(std::string,int,string)>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR_Dictionary, isa_proxy, 0,
                  sizeof(map<string,bool(TArtAnaFile::*)(std::string,int,string)>) );
      instance.SetNew(&new_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR);
      instance.SetNewArray(&newArray_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR);
      instance.SetDelete(&delete_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR);
      instance.SetDeleteArray(&deleteArray_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR);
      instance.SetDestructor(&destruct_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::MapInsert< map<string,bool(TArtAnaFile::*)(std::string,int,string)> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const map<string,bool(TArtAnaFile::*)(std::string,int,string)>*)0x0); R__UseDummy(_R__UNIQUE_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const map<string,bool(TArtAnaFile::*)(std::string,int,string)>*)0x0)->GetClass();
      maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) map<string,bool(TArtAnaFile::*)(std::string,int,string)> : new map<string,bool(TArtAnaFile::*)(std::string,int,string)>;
   }
   static void *newArray_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) map<string,bool(TArtAnaFile::*)(std::string,int,string)>[nElements] : new map<string,bool(TArtAnaFile::*)(std::string,int,string)>[nElements];
   }
   // Wrapper around operator delete
   static void delete_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p) {
      delete ((map<string,bool(TArtAnaFile::*)(std::string,int,string)>*)p);
   }
   static void deleteArray_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p) {
      delete [] ((map<string,bool(TArtAnaFile::*)(std::string,int,string)>*)p);
   }
   static void destruct_maplEstringcObooloPTArtAnaFilecLcLmUcPoPstdcLcLstringcOintcOstringcPgR(void *p) {
      typedef map<string,bool(TArtAnaFile::*)(std::string,int,string)> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class map<string,bool(TArtAnaFile::*)(std::string,int,string)>
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,vector<TArtValIndex> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,vector<TArtValIndex> >", -2, "map", 96,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,map<int,map<int,double> > >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,map<int,map<int,double> > >", -2, "map", 96,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,map<int,double> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,map<int,double> >", -2, "map", 96,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,TArtAnaGate*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<int,TArtAnaGate*>", -2, "map", 96,
...
"../../Nadeko/include",
"/usr/local/include",
"/home/hwchae07/Programs/anaroot/2016SAMURAI.s027/sources/AnaLoop/Core/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("analoop_dict",
        ...
        TriggerDictionaryInitialization_analoop_dict_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
