...
namespace WNum{
  ...
  // Definitions for CATANA analysis
  ...
  namespace HIME{
    enum {
      ...
      DetPosZ,      //6
      Hit,          //7
      DetDirect,    //8 : 0 -> Vertical ; 1 -> Horizontal
      ...
      // ID 0
      Multiplicity_N  = 100,  //100
      Multiplicity_N1 = 101,  //101
      Multiplicity_N2 = 102,  //102
      Multiplicity_N3 = 103,  //103 
      Multiplicity_N4 = 104,  //104
      Multiplicity_N5 = 105,  //105
      Multiplicity_V  = 110,  //110
    };
  }
